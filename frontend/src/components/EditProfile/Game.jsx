  ...
  return (
    <div className="games">
      ...
      <ul>
        ...
        >
          <img src="/pictures/csgo.png" alt="Counter Strike Global Offensive" />
        </li>
        <li
        ...
        <li
          className={selectedGames === "Heroes of the Storm" ? "selected" : ""}
        ...
        >
          <img src="/pictures/league_of_legends.png" alt="League of Legends" />
        </li>
        <li
        ...
        >
          <img src="/pictures/rainbow_six_siege.png" alt="Rainbow Six Siege" />
        </li>
        <li
        ...
        >
          <img src="/pictures/teamfight_tactics.png" alt="Teamfight Tactics" />
        </li>
        <li
